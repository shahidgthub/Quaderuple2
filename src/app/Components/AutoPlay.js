      ...
      <Slider {...settings}>
        <div>
          <div className='items-center justify-center flex'>
            <Image src={baber} className='xl:w-[311px] lg:w-[280px]  md:w-[270px] w-[250px] h-[352px] rounded-3xl' alt="Baber Azam" />
            <div className='bg-[#000000B2] xl:w-[311px]  lg:w-[280px] md:w-[270px] w-[250px] h-[69px] opacity-2 absolute mt-72 rounded-3xl'>
        ...
        <div>
          <div className='items-center justify-center flex'>
            <Image src={Fakhar} className='xl:w-[311px] lg:w-[280px] md:w-[270px] w-[250px] h-[352px] rounded-3xl' alt="Fakhar Zaman" />
            <div className='bg-[#000000B2] xl:w-[311px] lg:w-[280px] md:w-[270px] w-[250px] h-[69px] opacity-2 absolute mt-72 rounded-3xl'>
        ...
        <div>
          <div className='items-center justify-center flex'>
            <Image src={Shaheen} className='xl:w-[311px] lg:w-[280px] md:w-[270px] w-[250px] h-[352px] rounded-3xl' alt="Shaheen Afridi" />
            <div className='bg-[#000000B2] xl:w-[311px] lg:w-[280px] md:w-[280px] w-[250px] h-[69px] opacity-2 absolute mt-72 rounded-3xl'>
        ...
        <div>
          <div className='items-center justify-center flex'>
            <Image src={Haris} className='xl:w-[311px] lg:w-[280px] md:w-[270px] w-[250px] h-[352px] rounded-3xl' alt="Haris Rauf" />
            <div className='bg-[#000000B2] xl:w-[311px] lg:w-[280px] md:w-[270px] w-[250px] h-[69px] opacity-2 absolute mt-72 rounded-3xl'>
