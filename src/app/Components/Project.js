...
export const Project = () => {
  ...
  <div className="absolute top-0 left-6 lg:left-32 md:left-24">
    <Star className='text-[#448C74] w-[35px] h-[35px] lg:mt-10 md:mt-5 -mt-2'/>
  </div>
  <div className="absolute top-0 right-6 lg:right-32 md:right-24">
    <Star className='text-[#448C74] w-[35px] h-[35px] lg:mt-10 md:mt-5  -mt-2'/>
  </div>
  <h1 className='text-white lg:text-[40px] text-[32px] text-center py-6'>
    Our
    <span className='bg-hero-newbg bg-cover w-[206px] text-center lg:text-6xl text-3xl  px-4 rounded-2xl text-white'>
      Best Work
    </span> 
