        ...
        <header className='py-2'>
          <div className='md:container mx-auto px-5'>
           ...
           <ul className=' gap-x-5 lg:flex items-center hidden'>
                ...
                <Link href={"/services"} className='hover:text-green-500 text-[16px] font-bold'>Services</Link>
                <Link href={"/project"} className='hover:text-green-500 text-[16px] font-bold'>Project</Link>
                <Link href={"/blogs"} className='hover:text-green-500 text-[16px] font-bold'>Blogs</Link>
               </ul>
                <div>
